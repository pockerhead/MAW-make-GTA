...
Обновлено: 2026-09-24 13:43. Закрыто задач: 17. Время работы агентов: ~34 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 1359M чтение кэша, 25.1M запись в кэш | 2.38M | $445–520 |
