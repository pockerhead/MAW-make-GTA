...
Обновлено: 2026-09-23 21:58. Закрыто задач: 9. Время работы агентов: ~19 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 739M чтение кэша, 14.6M запись в кэш | 1.34M | $247–291 |
| Codex `gpt-6-sol` | 146.2M вход (из них 143.0M из кэша) | 0.35M | $38 |
