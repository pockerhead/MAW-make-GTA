...
- Следующий: TASK-014 (T13) — звук и juice.
...
Обновлено: 2026-09-24 17:34. Закрыто задач: 19. Время работы агентов: ~36 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 1524M чтение кэша, 28.1M запись в кэш | 2.60M | $497–582 |
