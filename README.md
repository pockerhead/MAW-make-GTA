...
- Следующий: TASK-024 — полировка розыска (читаемость звёзд, звонки о драках), потом TASK-012 (T11) полиция.
...
Обновлено: 2026-09-24 09:23. Закрыто задач: 15. Время работы агентов: ~30 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 1177M чтение кэша, 22.1M запись в кэш | 2.08M | $387–454 |
| Codex `gpt-6-sol` | 172.3M вход (из них 168.1M из кэша) | 0.45M | $47 |
