...
Обновлено: 2026-09-23 23:55. Закрыто задач: 11. Время работы агентов: ~21 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 844M чтение кэша, 16.2M запись в кэш | 1.54M | $280–329 |
| Codex `gpt-6-sol` | 152.1M вход (из них 148.6M из кэша) | 0.38M | $40 |
