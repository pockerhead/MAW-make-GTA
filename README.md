...
- Следующий: TASK-011 (T10) — розыск 1-5 звёзд.
...
Обновлено: 2026-09-24 07:28. Закрыто задач: 14. Время работы агентов: ~28 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 1105M чтение кэша, 20.8M запись в кэш | 1.94M | $364–426 |
| Codex `gpt-6-sol` | 162.1M вход (из них 158.2M из кэша) | 0.42M | $44 |
