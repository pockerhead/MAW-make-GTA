...
- TASK-015 (T14): готов — машина: припаркованные седаны у бордюров проспектов, F — сесть/выйти, подвеска на лучах,
  ...
  <!-- SHOWCASE:car:END -->
- Следующий: TASK-026 — свидетели убийства реально звонят в полицию, потом CI тестов и T15 (трафик и полицейские машины).
...
Обновлено: 2026-09-25 01:20. Закрыто задач: 21. Время работы агентов: ~44 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.02M без кэша, 1914M чтение кэша, 34.5M запись в кэш | 3.07M | $617–721 |
