...
- Следующие: TASK-035 (баланс урона), TASK-032 (трафик объезжает стоящие машины, полиция
...
Обновлено: 2026-09-26 08:36. Закрыто задач: 28. Время работы агентов: ~71 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.02M без кэша, 2857M чтение кэша, 63.7M запись в кэш | 3.99M | $970–1161 |
