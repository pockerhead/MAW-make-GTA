...
- Следующий: TASK-012 (T11) — полиция пешком и арест.
...
Обновлено: 2026-09-24 10:43. Закрыто задач: 16. Время работы агентов: ~31 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 1218M чтение кэша, 22.8M запись в кэш | 2.16M | $401–469 |
| Codex `gpt-6-sol` | 174.3M вход (из них 170.0M из кэша) | 0.46M | $47 |
