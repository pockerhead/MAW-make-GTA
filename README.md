...
- Следующие: TASK-034 (камера у стены), TASK-035 (баланс урона), TASK-032 (трафик объезжает стоящие машины, полиция
...
Обновлено: 2026-09-26 07:35. Закрыто задач: 27. Время работы агентов: ~70 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.02M без кэша, 2842M чтение кэша, 63.0M запись в кэш | 3.95M | $962–1151 |
