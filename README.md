...
- Следующий: TASK-015 (T14) — машина: угон и вождение.
...
Обновлено: 2026-09-24 20:22. Закрыто задач: 20. Время работы агентов: ~39 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.02M без кэша, 1658M чтение кэша, 30.7M запись в кэш | 2.82M | $542–634 |
...
Управление: WASD — бег, Shift — спринт, Alt — шаг, Space — прыжок, мышь — камера, Esc — пауза (продолжить, новый город по seed, настройки, выход),
