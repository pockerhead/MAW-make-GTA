...
- Следующий: TASK-023 — игрок застревает о столб на перекрёстке, потом TASK-010 (T9) банды.
...
Обновлено: 2026-09-24 02:13. Закрыто задач: 12. Время работы агентов: ~23 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 907M чтение кэша, 17.3M запись в кэш | 1.63M | $301–352 |
| Codex `gpt-6-sol` | 154.3M вход (из них 150.7M из кэша) | 0.39M | $41 |
