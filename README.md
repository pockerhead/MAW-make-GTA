...
- Следующий: TASK-031 — плейтест прототипа агентом-игроком, потом CI для релизов (TASK-028).
...
Обновлено: 2026-09-26 01:06. Закрыто задач: 25. Время работы агентов: ~64 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.02M без кэша, 2735M чтение кэша, 55.5M запись в кэш | 3.82M | $901–1068 |
