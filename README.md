...
Обновлено: 2026-09-24 16:50. Закрыто задач: 18. Время работы агентов: ~36 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.01M без кэша, 1504M чтение кэша, 27.7M запись в кэш | 2.58M | $491–574 |
