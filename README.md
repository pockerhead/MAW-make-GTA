...
- Следующий: TASK-017 (T16) — производительность и финальная приёмка, потом плейтест агентом.
...
Обновлено: 2026-09-25 14:58. Закрыто задач: 24. Время работы агентов: ~57 ч.

| Кто | Вход | Выход | ≈ USD |
|---|---|---|---|
| Claude Opus 5.5 (оркестратор + сабагенты) | 0.02M без кэша, 2510M чтение кэша, 45.9M запись в кэш | 3.63M | $804–942 |
